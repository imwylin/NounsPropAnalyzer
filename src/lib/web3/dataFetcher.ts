import type { Proposal, ProposalActions } from '../../features/governance/types/nouns'
...
function decodeProposal(_data: string): Proposal {
  // Implementation depends on contract ABI encoding
  throw new Error('Not implemented')
}

function decodeActions(_data: string): ProposalActions {
  // Implementation depends on contract ABI encoding
  throw new Error('Not implemented')
} 